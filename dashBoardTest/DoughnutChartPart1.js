...
export default function DoughnutChartPart1() {
    const chartRef = useRef(null);
    const [achievementRate, setAchievementRate] = useState(78);
        ...
        if(chartRef.current) {
            ...
            const textCenter = {
                ...
                beforeDraw(chart) {
                    ...
                    ctx.fillText("목표 달성률", xCenter, yCenter - lineHeight / 2); // 첫 번째 줄
